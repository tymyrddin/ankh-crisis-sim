...
This simulation is a model, not reality. See [Essential reading for aspiring patricians and those trying to spot them](https://indigo.tymyrddin.dev/docs/vetinari/resources).
